  ...
  return (
    <section className="section-padding bg-cream border-t border-gray-100">
      <div className="container-max">
        <AnimateIn className="text-center max-w-2xl mx-auto mb-10 md:mb-14">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-px bg-gray-100 border border-gray-100">
          {COLUMNS.map((col, i) => {
            const Icon = col.icon;
            return (
              <AnimateIn key={col.title} delay={i * 0.08} className="bg-white p-7">
        ...
        {/* What we don't */}
        <AnimateIn delay={0.4} className="mt-8 bg-charcoal text-white p-7 md:p-9">
        ...
        <AnimateIn delay={0.55} direction="none" className="text-center mt-10">
          <Link
            href="/services"
