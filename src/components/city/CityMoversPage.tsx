    ...
    <>
      ...
      <main className="pt-20 pb-16 lg:pb-0">
        ...
        <section className="bg-charcoal border-t border-white/5 py-7">
          <div className="absolute left-0 right-0 h-px gold-separator" />
        ...
        <section className="section-padding bg-white">
          <div className="container-max max-w-4xl mx-auto text-center">
            <p className="text-gold text-xs font-semibold tracking-[0.3em] uppercase mb-3">Service Area</p>
            ...
            <p className="text-gray-400 text-sm mt-6">
              ...
              <a href="tel:7863051844" className="text-gold hover:underline">Call us</a>
