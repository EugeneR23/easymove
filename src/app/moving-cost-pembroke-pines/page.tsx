...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    title: "How Much Do Movers Cost in Pembroke Pines? (2026 Prices)",
    description: page.metaDescription,
    url: `${siteUrl}/moving-cost-pembroke-pines`,
    images: [{ url: `${siteUrl}/images/Hero.png`, width: 1200, height: 630, alt: "Pembroke Pines moving costs 2026" }],
  },
  twitter: {
...
export default function MovingCostPembrokePinesPage() {
