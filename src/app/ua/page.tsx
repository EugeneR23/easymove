...
const FAQS = [
  ...
  },
  {
    ...
    "a": "Уся Південна Флорида: Голлівуд — наше домашнє місто, поруч Халландейл-Біч, Авентура, Санні-Айлс-Біч, Маямі, Форт-Лодердейл та сусідні міста округів Broward і Miami-Dade. Ми працюємо тільки локально: Miami-Dade, Broward і Palm Beach. Далеких і міжштатних переїздів не робимо — на них потрібен федеральний дозвіл, якого ми не маємо."
  },
  {
