...
const FAQS = [
  ...
  },
  {
    ...
    "a": "Уся Південна Флорида: Голлівуд — наше домашнє місто, поруч Халландейл-Біч, Авентура, Санні-Айлс-Біч, Маямі, Форт-Лодердейл та сусідні міста округів Broward і Miami-Dade. Локально працюємо в Miami-Dade, Broward і Palm Beach; далекі переїзди - у будь-яку точку Флориди за індивідуальним кошторисом. В інші штати речі не возимо: на це потрібен федеральний дозвіл, якого ми не маємо."
  },
  {
