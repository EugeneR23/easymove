 ...
 * those queries. The honest framing runs through every page here: the site is
 * in Ukrainian so it can be read comfortably; the crew and the coordinator work
 * in English and Russian. No page claims a Ukrainian-speaking crew.
 */
...
const FAQS = [
  {
    ...
    "a": "Сайт — так, повністю: усі сторінки, ціни та умови викладені українською саме для вас. Бригада та координатор працюють англійською та російською; україномовної команди ми не маємо й не заявляємо. Написати нам у WhatsApp українською можна сміливо — вас зрозуміють, а відповідь прийде російською або англійською, як вам зручніше."
  },
  {
