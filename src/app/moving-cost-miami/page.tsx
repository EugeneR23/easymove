...
export const metadata: Metadata = {
  ...
  description:
    'Miami movers charge $129/hour for 2 movers or $179/hour for 3, with a 3-hour minimum plus a flat $129/day truck fee. A 1-bedroom runs $516–$774 all-in. Full 2026 cost breakdown.',
  ...
  openGraph: {
    ...
    description:
      'Real 2026 Miami moving costs: $129/hr for 2 movers, $179/hr for 3, 3-hour minimum, $129/day truck. Studio $516–$645, 1BR $516–$774, 2BR $645–$1,203.',
...
const TOTALS = [
  ...
  { size: '2 bedrooms',    hours: '4–6 hours',  crew: '2–3 movers', total: '$645–$1,203' },
  { size: '3 bedrooms',    hours: '6–8 hours',  crew: '3 movers',   total: '$1,203–$1,561' },
  { size: '4+ bedrooms',   hours: '8–12 hours', crew: '3–4 movers', total: '$1,561–$2,277+' },
];

const HIDDEN_FEES = [
  { fee: 'Fuel surcharge', us: false, note: 'Fuel, tolls and mileage are inside the $129 truck fee.' },
  ...
  { fee: 'Truck fee', us: true, note: '$129 flat per day, stated as its own line on every estimate.' },
];

const FAQS = [
  {
    q: 'How much do movers charge per hour in Miami?',
    a: `Two movers with a truck cost $${HOURLY_RATE[2]} per hour and three movers $${HOURLY_RATE[3]} per hour, with a ${MIN_HOURS}-hour minimum. The truck is a separate flat fee of $${TRUCK_FEE} per day. Market rates across Miami-Dade generally run $100–$180 per hour for a two-mover crew, so this sits mid-range — the difference is usually in what gets added at the end, not in the headline rate.`,
  },
  {
    q: 'How much does moving a 1-bedroom apartment cost in Miami?',
    a: `A 1-bedroom typically takes 3 to 5 hours with two movers, which works out to $516–$774 all-in: hours × $${HOURLY_RATE[2]} plus the $${TRUCK_FEE} truck fee. A Brickell or Edgewater high-rise sits at the upper end because the freight elevator window controls the pace; a ground-floor walk-up with parking at the door lands at the lower end.`,
  },
  {
    q: 'What is the cheapest a Miami move can cost?',
    a: `$${MIN_INVOICE}. That is the ${MIN_HOURS}-hour minimum with two movers ($${MIN_HOURS * HOURLY_RATE[2]}) plus the $${TRUCK_FEE} truck fee. Nothing books below it, because a crew and a truck have to leave the yard either way.`,
  },
  {
    q: 'What hidden fees do moving companies add in Miami?',
    a: 'The common ones are a fuel surcharge, a per-flight stairs fee, an elevator or long-carry fee, a heavy-item fee, and weekend or peak-season percentage uplifts. None of those exist here: the only two lines on a local invoice are labour and the $129 truck fee. Ask any mover you are comparing to send the estimate in writing with every line named — the ones that add fees on move day are usually the ones who will not.',
  },
  {
        ...
        <section className="relative bg-charcoal py-20 md:py-24 overflow-hidden">
          ...
          <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <p className="text-gray-200 text-lg leading-relaxed mb-4">
              ...
              minimum, plus a flat <strong className="text-white">${TRUCK_FEE} per day for the truck</strong>. That makes the
              smallest possible invoice ${MIN_INVOICE}. A 1-bedroom apartment typically lands at $516–$774 all-in and a
              2-bedroom at $645–$1,203.
            </p>
              ...
              <table className="w-full text-left text-sm min-w-[480px]">
                ...
                <tbody>
                  ...
                  <tr className="border-b border-gray-100">
                    ...
                    <td className="px-5 py-4 text-gold font-bold whitespace-nowrap">${TRUCK_FEE}/day</td>
        ...
        <section className="section-padding bg-cream">
          <div className="container-max max-w-3xl">
            ...
            <p className="text-gray-500 leading-relaxed mb-6">
              Every figure is the same arithmetic: hours × hourly rate + the ${TRUCK_FEE} truck fee.
            </p>
