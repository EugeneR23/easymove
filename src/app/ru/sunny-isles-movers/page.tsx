...
export const metadata: Metadata = {
  ...
  alternates: alternatesFor('sunny-isles-movers', 'ru'),
  openGraph: {
    type: 'website',
    locale: 'ru_RU',
    ...
    images: [{ url: `${siteUrl}${city.heroImage}`, width: 1200, height: 630, alt: 'Русскоязычные грузчики в Sunny Isles Beach — Easy Move Florida' }],
  },
};
