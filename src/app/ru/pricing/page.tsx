...
export const metadata: Metadata = {
  ...
  description:
    'Почасовые ставки переезда в Южной Флориде: $129/час (2 грузчика) или $179/час (3 грузчика), минимум 3 часа. Грузовик от $90. Реальные суммы по размерам квартиры, что входит и что нет. Без скрытых сборов.',
  alternates: {
...
const PRICING_FAQS = [
  ...
  },
  {
    ...
    a: 'Только если инвентарь или доступ отличается от того, что вы описали. Если работа идёт дольше расчёта — та же ставка, без панических надбавок. Если видим риск перерасхода прямо во время работы — сразу говорим, чтобы вы могли решить.',
  },
  {
  ...
  {
    q: 'У меня смета до 15 мая 2026 — действуют ли старые цены?',
    a: 'Да. Клиенты, получившие письменную смету по прежним ставкам ($99/час за 2 грузчика, $139/час за 3, плата за грузовик $79) до 15 мая 2026, сохраняют эти цены для переезда, забронированного не позже 15 июня 2026. Просто принесите исходную смету.',
  },
  {
        ...
        <section className="section-padding bg-white border-t border-gray-100">
          <div className="container-max">
            ...
            <p className="text-center text-gray-400 text-xs mt-6">
              Плата за грузовик от $90 может применяться к первому часу. Выходные +10%. Пиковый сезон (май–сентябрь) +5%. Всё указано в вашей письменной смете, не в конце.
            </p>
          </div>
        </section>
        ...
        <section className="bg-charcoal py-16">
          <div className="container-max max-w-4xl text-center">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
              {[
                { title: 'Полная страховка', desc: 'Стандартное покрытие на каждом переезде. COI в ваше здание за 24 часа.' },
