...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description:
      'Реальные цены на переезд в Южной Флориде: студия $376–$496, 1 комн. $450–$594, 2 комн. $525–$705, 3 комн. $750–$990. Всё включено в почасовую ставку.',
  ...
  twitter: {
    ...
    description: 'От $99/час, минимум 3 часа. Без надбавок за топливо, без оплаты за лестницы, без сюрпризов.',
    images: [`${siteUrl}/images/Hero.png`],
  },
};

const APARTMENT_TOTALS = [
  { size: 'Студия',                 hours: '3–4 часа',   crew: '2 грузчика', range: '$376–$496',    details: 'Кровать, диван, комод, ~15 коробок' },
  { size: '1-комнатная',            hours: '3–4.5 часа', crew: '2 грузчика', range: '$450–$594',    details: 'Кровать, диван, комод, обеденный стол, ~25 коробок' },
  { size: '2-комнатная',            hours: '4.5–6 часов', crew: '2 грузчика', range: '$525–$705',   details: 'Две спальни, диван, обеденная группа, ~40 коробок' },
  { size: '3-комнатная',            hours: '5–7 часов',  crew: '3 грузчика', range: '$750–$990',    details: 'Три спальни, гостиная, столовая, ~60 коробок' },
  { size: '4+ комнаты / дом',       hours: '7–10 часов', crew: '3 грузчика', range: '$990–$1,400+', details: 'Дом целиком — рекомендуем осмотр на месте' },
  { size: 'Офис (до 20 человек)',   hours: '6–9 часов',  crew: '3 грузчика', range: '$890–$1,300',  details: 'Столы, кресла, техника, документация' },
];
...
const FACTORS = [
  ...
  },
  {
    ...
    body: 'Два грузчика ($99/час) — оптимальный вариант для большинства студий и 1-комнатных. Три грузчика ($139/час) заканчивают 2-комнатную примерно на 30% быстрее, поэтому итоговая сумма часто получается похожей.',
  },
  {
  ...
  },
  {
    ...
    body: 'Полная упаковка добавляет 2–6 часов в зависимости от размера квартиры по тарифу упаковки ($79/час за 2 упаковщиков, $119/час за 3). Частичная упаковка — только кухня и хрупкие вещи — обычно добавляет 2–3 часа.',
  },
  {
...
const PRICING_FAQS = [
  ...
  },
  {
    ...
    a: 'Суббота — та же почасовая ставка. Воскресенья и крупные праздники доступны только для заранее забронированных корпоративных переездов и могут иметь отдельный тариф, раскрытый заранее.',
  },
  {
        ...
        <section className="section-padding bg-white border-t border-gray-100">
          <div className="container-max">
            ...
            <p className="text-center text-gray-400 text-xs mt-6">
              Плата за грузовик от $79 может применяться к первому часу. Указана в вашей письменной смете, не в конце.
            </p>
          </div>
        </section>
