...
export const metadata: Metadata = {
  ...
  description:
    'Почасовые ставки переезда в Южной Флориде: $129/час (2 грузчика) или $179/час (3 грузчика), минимум 3 часа. Письменная смета с жестким потолком: финальный счет не превысит ее больше чем на 15%.',
  alternates: {
  ...
  openGraph: {
    ...
    description:
      'Реальные цены на переезд в Южной Флориде: студия $477–$606, 1 комн. $477–$671, 2 комн. $671–$864, 3 комн. $985–$1,343. Всё включено в почасовую ставку.',
  ...
  twitter: {
    ...
    description: 'От $129/час, минимум 3 часа. Письменная смета с потолком 15%. Без надбавок за топливо, без оплаты за лестницы, без сюрпризов.',
    images: [`${siteUrl}/images/Hero.png`],
  },
};

const APARTMENT_TOTALS = [
  { size: 'Студия',                 hours: '3–4 часа',   crew: '2 грузчика',   range: '$477–$606',     details: 'Кровать, диван, комод, ~15 коробок' },
  { size: '1-комнатная',            hours: '3–4.5 часа', crew: '2 грузчика',   range: '$477–$671',     details: 'Кровать, диван, комод, обеденный стол, ~25 коробок' },
  { size: '2-комнатная',            hours: '4.5–6 часов', crew: '2 грузчика',  range: '$671–$864',     details: 'Две спальни, диван, обеденная группа, ~40 коробок' },
  { size: '3-комнатная',            hours: '5–7 часов',  crew: '3 грузчика',   range: '$985–$1,343',   details: 'Три спальни, гостиная, столовая, ~60 коробок' },
  { size: '4+ комнаты / дом',       hours: '7–10 часов', crew: '3–4 грузчика', range: '$1,343–$2,380+', details: 'Дом целиком — рекомендуем осмотр на месте' },
  { size: 'Офис (до 20 человек)',   hours: '6–9 часов',  crew: '3 грузчика',   range: '$1,164–$1,701', details: 'Столы, кресла, техника, документация' },
];

const INCLUDED = [
  'Два (или три) грузчика на весь объём работы',
  'Грузовик с топливом и платными дорогами',
  'Защитные пледы, стрейч-плёнка, чехлы для матрасов',
  ...
  '15-минутное окно прибытия или скидка 10%',
  'Письменная смета с жестким потолком до начала любых работ',
];
...
const PRICING_FAQS = [
  ...
  },
  {
    ...
    a: 'У письменной сметы есть жесткий потолок: финальный счет не превысит ее больше чем на 15 процентов. Если работа идёт дольше расчёта — та же ставка, без панических надбавок. Если видим риск перерасхода прямо во время работы — сразу говорим, чтобы вы могли решить.',
  },
  {
    q: 'Берёте ли вы депозит?',
    a: 'Нет депозита на локальные переезды. Для дальних переездов нужен небольшой депозит (обычно 10%), чтобы зарезервировать грузовик — он полностью идёт в счёт финального счёта.',
  },
  {
  ...
  },
  {
    ...
    a: 'Топливной надбавки нет. Платы за лестницы нет при обычных лестничных пролётах. Тяжёлые специальные предметы (пианино, сейф, мрамор) — фиксированная сумма заранее, никогда не выставляется в конце.',
  },
  {
  ...
  },
  {
    ...
    a: 'Суббота и воскресенье — надбавка 10% к будничной почасовой ставке, указана в письменной смете заранее (не добавляется задним числом). Воскресенья и крупные праздники — ограниченная доступность, бронируйте заранее.',
  },
  {
    q: 'Есть ли сезонная надбавка?',
    a: 'Да. С мая по сентябрь (пиковый сезон переездов во Флориде) действует сезонная надбавка 5% к стандартной почасовой ставке. Она указана в смете до бронирования и складывается с надбавкой за выходные, если переезд приходится на субботу или воскресенье в этом окне.',
  },
  {
    q: 'Что будет, если бригада опоздала или что-то сломалось?',
    a: 'Опоздание на 30 и больше минут: скидка 10%. Если что-то сломалось: мы исправляем это до того, как берем оплату. Обе гарантии входят в каждую письменную смету.',
  },
  {
        ...
        <section className="relative bg-charcoal py-20 md:py-28 overflow-hidden">
          ...
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <p className="text-gray-300 text-lg leading-relaxed max-w-2xl mx-auto mb-8">
              Письменная смета с жестким потолком: финальный счет не превысит ее больше чем на 15 процентов. Без надбавок за топливо, без оплаты за лестницы, без сюрпризов в день переезда.
            </p>
        ...
        <section className="section-padding bg-white border-t border-gray-100">
          <div className="container-max">
            ...
            <p className="text-center text-gray-400 text-xs mt-6">
              Плата за грузовик от $90 может применяться к первому часу. Минимум 3 часа на любой заказ. Выходные +10%. Пиковый сезон (май–сентябрь) +5%. Всё указано в вашей письменной смете, не в конце.
            </p>
          </div>
        </section>
          ...
          <div className="container-max max-w-5xl">
            <div className="mb-10">
              ...
              <p className="text-gray-500 leading-relaxed max-w-2xl">
                Диапазоны ниже отражают нижнюю и верхнюю границу нормального переезда — лёгкий доступ, стандартный инвентарь, без специальных предметов. Пришлите 5 фото в WhatsApp, через 30 минут у вас письменная оценка. И главное: финальный счет не превысит ее больше чем на 15 процентов. Письменно.
              </p>
            </div>
        ...
        <section className="bg-charcoal py-16">
          <div className="container-max max-w-4xl text-center">
            ...
            <h2 className="font-display text-2xl md:text-3xl font-bold text-white mb-8 leading-tight">
              Письменная смета с жестким потолком: финальный счет не превысит ее больше чем на 15 процентов.
            </h2>
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
              {[
                { title: 'Потолок 15%, письменно', desc: 'Смета, которую вы утвердили, это потолок. Финальный счет не превысит ее больше чем на 15 процентов.' },
                { title: 'Вовремя или скидка 10%', desc: 'Опоздание на 30 и больше минут: скидка 10% от счета.' },
                { title: 'Исправляем до оплаты', desc: 'Если что-то сломалось, мы исправляем это до того, как берем оплату. COI в ваше здание за 24 часа.' },
              ].map((g) => (
                <div key={g.title}>
