...
const FACTORS = [
  ...
  },
  {
    ...
    body: 'Два грузчика ($129/час) — оптимальный вариант для большинства студий и 1-комнатных. Три грузчика ($179/час) заканчивают 2-комнатную примерно на 30% быстрее, поэтому итоговая сумма часто получается похожей. Четыре грузчика ($219/час) — для домов 4+ спальни или жёстких лифтовых окон. Учтите: строка за трак растёт вместе с бригадой.',
  },
  {
