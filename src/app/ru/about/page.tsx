...
const VALUES = [
  ...
  },
  {
    ...
    body: 'Южная Флорида — это требования HOA, окна грузовых лифтов, трафик по I-95 и жара, от которой страдает мебель в кузове. Всё это мы выясняем по вашему адресу до даты и закладываем в часы, а не обнаруживаем на месте.',
  },
];
