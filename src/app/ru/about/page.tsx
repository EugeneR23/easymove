...
export const metadata: Metadata = {
  ...
  description:
    'EasyMove Elite — полностью застрахованная мувинговая компания в Южной Флориде, основанная Евгением Романовым. Переезды по Майами, Форт-Лодердейл, Бока-Ратон. Говорим по-русски.',
  alternates: {
