...
const FAQS = [
  {
    ...
    a: 'Локальные переезды оплачиваются почасово: $129/час за 2 муверов, $179/час за 3, $229/час за 4, минимум 3 часа. Грузовик от $90 в зависимости от расстояния. Студия от $477, 2-комнатная от $671. Выходные +10%, пиковый сезон (май–сентябрь) +5%. Финальный счет не превысит письменную смету больше чем на 15 процентов.',
  },
  {
