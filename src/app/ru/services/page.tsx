...
const SERVICES = [
  ...
  {
    icon: Truck,
    title: 'Дальние переезды по Флориде',
    desc: 'Орландо, Тампа, Нейплс, Джексонвилл — считаем индивидуально и присылаем письменную смету, депозита нет. В другой штат не возим: на это нужно федеральное разрешение, которого у нас нет — подскажем лицензированного перевозчика, а упаковку и флоридское плечо возьмём на себя.',
    price: 'по смете',
