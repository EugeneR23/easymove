...
export const BLOG_POSTS: BlogPost[] = [
  ...
  // ─── Long-tail post #6: Russian-speaking residents ───────────────────────
  {
    ...
    body: [
      ...
      { type: 'p', text: 'Базовая ставка: $129/час за 2 грузчика, $179/час за 3, $229/час за 4, минимум 3 часа. Грузовик — от $90. Выходные +10%, пиковый сезон (май–сентябрь) +5%. Все цены прозрачны: вы получаете письменную смету до бронирования. Никаких сюрпризов в день переезда.' },
