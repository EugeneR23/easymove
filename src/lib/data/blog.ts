...
export const BLOG_POSTS: BlogPost[] = [
  ...
  // ─── Long-tail post #6: Russian-speaking residents ───────────────────────
  {
    ...
    body: [
      ...
      { type: 'p', text: 'Базовая ставка: $99/час за 2 грузчика или $139/час за 3, минимум 3 часа. Грузовик — от $79. Все цены прозрачны: вы получаете письменную смету до бронирования. Никаких сюрпризов в день переезда.' },
